...
class _EmergencyContactsScreenState extends State<EmergencyContactsScreen> {
  ...
  Future<void> _sendLocationViaSMS(EmergencyContact contact, Position position) async {
    try {
      final telephony = Telephony.instance;
      final String message = 'EMERGENCY: I need help! My current location is: https://www.google.com/maps?q=${position.latitude},${position.longitude}';
      ...
      _showErrorSnackBar('Failed to send location via SMS');
    }
  }
  ...
  Future<void> _callContact(EmergencyContact contact) async {
    ...
    if (position != null) {
      ...
      await _sendLocationViaSMS(contact, position);
    }
